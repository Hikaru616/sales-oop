...
if(isset($_POST['btn_pay'])) {
    $user->updateQuantity($product, $_POST);
}
...
<body>
    ...
    <div class="container w-50 mx-auto mt-5">
        <form action="../views/payment.php?id=<?= $id ?>" method="post">
            <h1 class="text-success text-center fw-bold" style="letter-spacing: 5px;"><i class="fa-solid fa-cash-register"></i> Buy Product</h1>
                <div class="row mt-5 w-75 mx-auto">
                    ...
                    <p class="col-6 text-secondary mt-3">price</p>
                    <p class="col-6 text-secondary mt-3">Stocks Left</p>
                    <h2 class="col-6 fw-bold">$ <?= $product['price'] ?></h2>
                    <h2 class="col-6 fw-bold"><?= $product['quantity'] ?></h2>
                    <p class="col-12 text-secondary mt-3">Buy Quantity</p>
                    <div class="col-12">
                        <input type="number" name="quantity" class="w-75 form-control mx-auto" min="0" max="<?= $product['quantity'] ?>" required>
                    </div>
                    <div class="col-12">                      
